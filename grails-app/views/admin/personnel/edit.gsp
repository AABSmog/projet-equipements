...
<body>
    ...
    <div class="bg-white border border-gray-200 p-6 max-w-lg">
        ...
        <form action="/admin/personnel/update" method="post">
            ...
            <div class="mb-4"><label class="block text-sm font-semibold text-gray-700 mb-1">Mot de passe (laisser vide pour conserver)</label><input type="password" name="motDePasse" class="w-full px-3 py-2 border border-gray-300 text-sm focus:outline-none focus:border-gray-600"/></div>
